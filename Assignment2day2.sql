...
create table EMP(
	...
	salary numeric(7),
	comm numeric(6),
	deptno numeric(4) foreign key references DPT(deptno)
)
...
INSERT INTO DPT(Deptno,Dname,Loc) VALUES (40,'OPERATIONS','BOSTON')

INSERT INTO EMP(EMPNO,ENAME,JOB,MGR_Id,HIREDATE,SALARY,COMM,DEPTNO) VALUES (7369,'SMITH','CLERK','7902','17-DEC-80',800,NULL,20)
INSERT INTO EMP(EMPNO,ENAME,JOB,MGR_Id,HIREDATE,SALARY,COMM,DEPTNO) VALUES (7499,'ALLEN','SALESMAN','7698','20-FEB-81',1600,300,30)
...
INSERT INTO EMP(EMPNO,ENAME,JOB,MGR_Id,HIREDATE,SALARY,COMM,DEPTNO) VALUES (7782,'CLARK','MANAGER','7839','09-JUN-81',2450,NULL,20)
...
INSERT INTO EMP(EMPNO,ENAME,JOB,MGR_Id,HIREDATE,SALARY,COMM,DEPTNO) VALUES (7935,'MILLER-2','CLERK','7782','23-JAN-82',1300,NULL,null)
...
-- ques4.
select ename, salary from EMP e join DPT d on  e.deptno = d.deptno where dname = 'RESEARCH'
update EMP set salary = ( salary + salary * 0.1) where deptno = (select deptno from DPT where dname = 'RESEARCH')
-- ques5.
select count(*) 'NUMBER OF CLERKS' from EMP where job = 'CLERK'
--ques6.
select avg(salary) 'AVERAGE SALARY', count(empno) 'NUMBER OF EMPLOYEES' from EMP group by job
--ques7.
...
--ques8.
select * from DPT d where not exists (select * from EMP e where e.deptno = d.deptno )
--ques9.
select ename, salary from EMP  where job = 'ANALYST' and salary > 1200 and deptno = 20 order by ename desc
-- ques10.
select d.dname, d.deptno, sum(salary) 'total salary of all employees' from EMP e join DPT d on e.deptno = d.deptno group by d.dname, d.deptno
--ques11.
...
--ques13.
select ( salary * 12 ) as 'YEARLY SALARY OF SMITH ' from EMP where ename = 'SMITH'
